      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-900/40 via-slate-900/80 to-blue-900/40 border border-indigo-500/30 p-8 sm:p-12 text-center">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-slate-300 max-w-lg mx-auto text-base sm:text-lg mb-8 leading-relaxed">
              {lang === "ar" 
            ...
            {isPro ? (
              <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 font-semibold shadow-lg shadow-emerald-500/10 transition-all">
              ...
              <button 
                ...
                className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-lg shadow-[0_0_20px_rgba(99,102,241,0.4)] hover:shadow-[0_0_30px_rgba(99,102,241,0.6)] transition-all hover:-translate-y-1"
              >
        ...
        {/* Features Grid */}
        <div>
          <h2 className="text-xl font-bold text-slate-200 mb-6 px-2">
            {lang === "ar" ? "الميزات الحصرية" : "Exclusive Features"}
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {features.map((feat, i) => (
              <div key={i} className="p-5 rounded-2xl bg-slate-900/50 border border-slate-800 flex flex-col gap-3 hover:bg-slate-800/80 transition-colors">
                <div className="w-10 h-10 rounded-full bg-indigo-500/10 flex items-center justify-center border border-indigo-500/20">
                  {feat.icon}
                </div>
                <div>
                  <h3 className="text-slate-200 font-semibold text-base mb-1">{feat.title}</h3>
